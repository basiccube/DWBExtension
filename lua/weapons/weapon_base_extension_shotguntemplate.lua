...
SWEP.PrintName = "Weapon Base Extension Shotgun" -- Weapon name in spawn menu and in weapon selection HUD.
...
-- Shotgun double fire shoot sound.
SWEP.ShotgunSecondarySound = Sound("weapons/shotgun/shotgun_dbl_fire7.wav", 75, 100, 1, CHAN_WEAPON)
